...
class General(commands.Cog, name="General"):
    def __init__(self, bot: commands.Bot):
        self.bot = bot
        self.ctx_menu = app_commands.ContextMenu(name="Text CTX Menu",
                                                 callback=self.ctx_menu_command,
    ...
    async def ctx_menu_command(self, interaction: discord.Interaction, message: discord.Message):
        await interaction.response.send_message("Wow, that's a message.")
